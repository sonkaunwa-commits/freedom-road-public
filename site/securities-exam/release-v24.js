...
function health(){
 ...
 window.SEC_RELEASE_HEALTH={version:'2.9',pass,total:B.length,strict:strict.length,open,finance,law,invalid,duplicateIds:dups.length,plan};
 const v=document.querySelector('.version');if(v)v.textContent='在线刷题 · v2.9 · 手机/电脑双端 · 已验收 · 独立考前计划';
